...
export const RP_ICONS: Record<string, string[]> = {
  ...
  'eye-off': [
    ...
    'M9.4 5.2A9 9 0 0 1 12 5c6.5 0 10 7 10 7a13 13 0 0 1-2.2 2.9',
    'M6.1 6.1A13 13 0 0 0 2 12s3.5 7 10 7a9 9 0 0 0 3-.5',
  ],
  upload: ['M12 4v12', 'M8 8l4-4 4 4', 'M5 20h14'],
  file: [
    'M14 3v4a1 1 0 0 0 1 1h4',
    'M5 3h9l5 5v11a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2',
  ],
  paperclip: [
    'M21 12l-9 9a5 5 0 0 1-7-7l9-9a3.5 3.5 0 0 1 5 5l-9 9a2 2 0 0 1-3-3l8-8',
  ],
};
